...
```sh
uv run --upgrade https://raw.githubusercontent.com/aabmass/opentelemetry-python-contrib/refs/heads/vertex-streamlit-langgraph/instrumentation-genai/opentelemetry-instrumentation-vertexai/examples/langgraph-chatbot-demo/run_streamlit.py
```

### With cloned repo

```sh
git clone --branch=vertex-streamlit-langgraph https://github.com/aabmass/opentelemetry-python-contrib.git
...
docker build \
--build-arg GIT_REF=vertex-streamlit-langgraph \
-t us-central1-docker.pkg.dev/${PROJECT}/oci/langgraph-chatbot-demo:${TAG} \
https://raw.githubusercontent.com/aabmass/opentelemetry-python-contrib/refs/heads/vertex-streamlit-langgraph/instrumentation-genai/opentelemetry-instrumentation-vertexai/examples/langgraph-chatbot-demo/Dockerfile
```
